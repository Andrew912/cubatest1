...
@NamePattern("%s|namo")
@Table(name = "tipi_nagrad")
@Entity(name = "test2_TipiNagrad")
public class TipiNagrad extends BaseUuidEntity implements SoftDelete, Updatable, Creatable {
    private static final long serialVersionUID = -8251301605353471520L;
