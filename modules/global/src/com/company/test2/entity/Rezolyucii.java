...
@NamePattern("%s|namo")
@Table(name = "rezolyucii")
@Entity(name = "test2_Rezolyucii")
public class Rezolyucii extends BaseUuidEntity implements SoftDelete, Updatable, Creatable {
    private static final long serialVersionUID = 2100951955331254742L;
