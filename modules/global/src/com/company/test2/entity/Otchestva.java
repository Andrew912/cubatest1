...
@NamePattern("%s|namo")
@Table(name = "otchestva")
@Entity(name = "test2_Otchestva")
public class Otchestva extends BaseUuidEntity implements SoftDelete, Updatable, Creatable {
    private static final long serialVersionUID = -2519118125794617454L;
