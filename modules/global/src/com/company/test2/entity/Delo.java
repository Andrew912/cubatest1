...
@NamePattern("%s|namo")
@Table(name = "delo")
@Entity(name = "test2_Delo")
public class Delo extends BaseUuidEntity implements SoftDelete, Updatable, Creatable {
    private static final long serialVersionUID = -9138844345872729316L;
