...
@NamePattern("%s|namo")
@Table(name = "imena")
@Entity(name = "test2_Imena")
public class Imena extends BaseUuidEntity implements SoftDelete, Updatable, Creatable {
    private static final long serialVersionUID = 8170725911287644674L;
