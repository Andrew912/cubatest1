...
@NamePattern("%s|namo")
@Table(name = "territoriya")
@Entity(name = "test2_Territoriya")
public class Territoriya extends BaseUuidEntity implements SoftDelete, Updatable, Creatable {
    private static final long serialVersionUID = -7519234902273000435L;
