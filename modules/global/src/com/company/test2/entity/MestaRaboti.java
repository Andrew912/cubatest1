...
@NamePattern("%s|namo")
@Table(name = "mesta_raboti")
@Entity(name = "test2_MestaRaboti")
public class MestaRaboti extends BaseUuidEntity implements SoftDelete, Updatable, Creatable {
    private static final long serialVersionUID = -3963373149343180910L;
